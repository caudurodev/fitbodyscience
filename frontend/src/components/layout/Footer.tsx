      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/privacy-policy" className="text-small text-default-500 hover:text-primary transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-small text-default-500 hover:text-primary transition-colors">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-small text-default-500 hover:text-primary transition-colors">
                  FAQ
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/contact" className="text-small text-default-500 hover:text-primary transition-colors">
                  Contact Form
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-divider pt-8">
          <p className="text-center text-small text-default-400">
            {new Date().getFullYear()} Fitbody Science. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
